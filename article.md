...
```python tags=["table-corpuspreview-*", "data-table"]
excerpt_df = (doc_df
...
```python editable=true slideshow={"slide_type": ""} tags=["figure-corpusbarplot-*"]
...
```python editable=true slideshow={"slide_type": ""} tags=["table-whispererrors-*", "data-table"]
...
```python editable=true slideshow={"slide_type": ""} tags=["figure-evaluation-*"]
import numpy as np
import pandas as pd
...
```python editable=true jdh={"object": {"source": ["Topics and top 10 words for each of the 19 topics in Bertopic model V78, ranked by C-TF-IDF"]}} slideshow={"slide_type": ""} tags=["figure-topicbarchart78HTML-*"]
p2=78
...
```python tags=["figure-topicbarchart78PNG-*"]
...
```python tags=["figure-topicbarchart48PNG-*"]
# Fallback to the png version in case HTML fails to display
...
```python tags=["figure-topicsmap78HTML-*"]
...
```python tags=["figure-topicsmap78PNG-*"]
...
```python tags=["figure-topicsdyn78HTML-*"]
import numpy as np
import plotly.graph_objects as go
...
```python tags=["figure-topicsdyn78PNG-*"]
...
```python editable=true slideshow={"slide_type": ""} tags=["video-blast-*"]
# Load video from YT
...
```python editable=true slideshow={"slide_type": ""} tags=["table-blast-*"]
